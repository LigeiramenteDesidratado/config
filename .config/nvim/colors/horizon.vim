...
hi! StatusLine cterm=reverse ctermbg=133 ctermfg=0 gui=reverse guibg=#17171b guifg=#818596 term=reverse
...
hi! WildMenu ctermbg=236 ctermfg=209 guibg=#d4d5db guifg=#17171b
